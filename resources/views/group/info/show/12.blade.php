...
<div>           <!-- 検索用のhtml -->
    <input type="text" class="" id="search2"> <input type="button" class="btn btn-primary" value="絞り込む" id="button3"> <input type="button" class="btn btn-primary" value="すべて表示" id="button4">
    <br>
        <div class="card">
            <ul>
