<form method="POST" action="{{ route('user.questionnaire.update',[$base->id]) }}">
    ...
    <div id="questionnaire_body">
            ...
            <ul class="nav nav-pills nav-pills-icons d-flex justify-content-between px-0" data-tabs="tabs">
                <li class="nav-item mx-auto w-25 @if(in_array('feeling', $info['not_use_items'])) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#1" id="t1" data-toggle="tab">調子</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('syokuyoku', $info['not_use_items'])) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#2" id='t2' data-toggle="tab">食欲</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('otuzi', $info['not_use_items'])) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#3" id="t3" data-toggle="tab">お通じ</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('taion', $info['not_use_items'])) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#4" id="t4" data-toggle="tab">体温</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('taiju', $info['not_use_items'])) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#5" id="t5" data-toggle="tab">体重</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('ketuatu', $info['not_use_items'])) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#6" id="t6" data-toggle="tab">血圧</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('warui_bui', $info['not_use_items'])) d-none @endif">
                    <a class="nav-link h4 px-0 my-1" style="min-width:50px;" href="#7" id="t7" data-toggle="tab">症状</a>
                </li>
                <li class="nav-item mx-auto w-25 @if(in_array('comment', $info['not_use_items'])) d-none @endif">
                ...
                <div class="tab-content text-center mt-3">
                    ...
                    <div class="tab-pane @if(in_array('feeling', $info['not_use_items'])) d-none @endif" id="1">
                    ...
                    <div class="tab-pane @if(in_array('syokuyoku', $info['not_use_items'])) d-none @endif" id="2"> <!質問２>
                    ...
                    <div class="tab-pane @if(in_array('otuzi', $info['not_use_items'])) d-none @endif" id="3"><!質問３>
                    ...
                    <div class="tab-pane @if(in_array('taion', $info['not_use_items'])) d-none @endif" id="4"><!質問4>
                    ...
                    <div class="tab-pane @if(in_array('taiju', $info['not_use_items'])) d-none @endif" id="5"><!質問5>
                    ...
                    <div class="tab-pane @if(in_array('ketuatu', $info['not_use_items'])) d-none @endif" id="6"><!質問6>
                    ...
                    <div class="tab-pane @if(in_array('warui_bui', $info['not_use_items'])) d-none @endif" id="7"><!質問7>
                    ...
                    <div class="tab-pane @if(in_array('comment', $info['not_use_items'])) d-none @endif" id="8">
                        <p class="h2">コメント</p>
                    ...
                    <div class="tab-pane" id="9">
                        <p class="h2">回答一覧</p>
                        <table class="table">
                            <tr class="@if(in_array('feeling', $info['not_use_items'])) d-none @endif"><td>調子</td><td><div id="tyousi_out"></div></td></tr>
                            <tr class="@if(in_array('syokuyoku', $info['not_use_items'])) d-none @endif"><td>食欲</td><td><div id="syokuyoku_out"></div></td></tr>
                            <tr class="@if(in_array('otuzi', $info['not_use_items'])) d-none @endif"><td>お通じ </td><td><div id="otuzi_out"></div></td></tr>
                            <tr class="@if(in_array('taion', $info['not_use_items'])) d-none @endif"><td>体温 </td><td><div id="taion_out"></div></td></tr>
                            <tr class="@if(in_array('taiju', $info['not_use_items'])) d-none @endif"><td>体重 </td><td><div id="taiju_out"></div></td></tr>
                            <tr class="@if(in_array('ketuatu', $info['not_use_items'])) d-none @endif"><td>血圧 </td><td><div id="ketuatu_out"></div></td></tr>
                            <tr class="@if(in_array('warui_bui', $info['not_use_items'])) d-none @endif"><td>症状</td><td><div id="warui_bui_out"></div></td></tr>
                            <tr class="@if(in_array('comment', $info['not_use_items'])) d-none @endif"><td>コメント</td><td><div id="comment_out"></div></td></tr>
