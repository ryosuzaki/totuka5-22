<form method="POST" action="{{ route('user.info_base.info.update',[$user->id,$info->id]) }}">
    ...
    <div>
        ...
        <div>【性別】
            ...
            <div>
                <div class="form-group col-md-6">
                    <input type="number" placeholder="year" class="form-number" name="info[you3]" value="">年
                </div>
                <div class="form-group col-md-6">
                    <input type="number" placeholder="month" class="form-number" name="info[you4]" value="">月
                </div>
                <div class="form-group col-md-6">
                    <input type="number" placeholder="day" class="form-number" name="info[you5]" value="">日
                </div>
            </div>【住所】
            <div class="form-group col-md-6">
        ...
        【電話番号】
            <div>
                <input type="tel" class="form-tel" name="info[you9]" value="">
            </div>
            【位置情報サービス】
            <div class="form-check form-check-radio">
                <label class="form-check-label">    
    ...
    <div>
        ...
        <input type="tel" class="form-tel" name="info[fami8]" value=""><br>
        【メールアドレス】
        <input type="email" class="form-email" name="info[fami9]" id="exampleFormControlInput1" placeholder="name@example.com">
    </div>
    <div>
        <h2>住まい</h2>
        <div>【同居人の有無】
